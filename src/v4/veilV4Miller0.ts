...
/** Optimized-v4 Miller slice 1 of 4 (23 prepared lines). */
export class VeilV4Miller0 extends SmartContract {
    @prop(true)
    stateHash: Sha256
