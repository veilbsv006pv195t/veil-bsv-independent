...
/** Optimized-v4 Miller slice 2 of 4 (21 prepared lines). */
export class VeilV4Miller1 extends SmartContract {
    @prop(true)
    stateHash: Sha256
    ...
    @prop()
    readonly gammaLines: FixedArray<PreparedLine, 21>

    @prop()
    readonly deltaLines: FixedArray<PreparedLine, 21>

    constructor(
        stateHash: Sha256,
        nextCodeHash: Sha256,
        gammaLines: FixedArray<PreparedLine, 21>,
        deltaLines: FixedArray<PreparedLine, 21>
    ) {
        super(...arguments)
